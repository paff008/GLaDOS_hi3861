...
extern int tencent_connect_flag =0;
extern uint8_t dededa = 0;
...
static const char *gDefaultSubscribeTopic[] = {
    ...
    "JIFGEUU5BK/hi3861_GLaDOS/data",
    "JIFGEUU5BK/hi3861_GLaDOS/event",
    "JIFGEUU5BK/hi3861_GLaDOS/control",
};
...
static void MainEntryProcess(void)
{
    ...
    while (MQTTClient_isConnected(client)) {
        ...
        //这里标志着程序以及连接到了tencent云服务
        printf("连接到了 tencent 累死");
        //printf_GLaDOS();
        //printf_success();
        dededa =1;

        tencent_connect_flag = 1;
...
int IoTSetMsgCallback(fnMsgCallBack msgCallback)
{
    ...
    printf("iot set msg call back 这是 %d\n",msgCallback);
