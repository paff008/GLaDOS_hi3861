...
void printf_science(){
    ...
    OledShowString(0, 2, "Aperture Science", 1);
    OledShowString(30, 3, "Welcome ", 1);
    OledShowString(10, 4, "GLaDOS connect", 1); 
}
void printf_GLaDOS(){
    IoTI2cInit(AHT20_I2C_IDX, AHT20_BAUDRATE);
    OledShowString(10, 4, "GLaDOS connect", 1); 
...
void printf_success(){
    IoTI2cInit(AHT20_I2C_IDX, AHT20_BAUDRATE);
    OledShowString(30, 5, "success", 1); 
}

void printf_failure(){
    IoTI2cInit(AHT20_I2C_IDX, AHT20_BAUDRATE);
    OledShowString(30, 5, "failure", 1); 
}
static void OledmentTask(const char *arg)
{
    ...
    OledShowString(20, 2, "Aperture Science", 1); /* 屏幕第20列3行显示1行 */
}
